...
import { UseSEOProps } from "@/interfaces/interface-use-seo-props";
...
export function useSEO({
  ...
  useEffect(() => {
    ...
    if (image) {
      updateMetaProperty(
        "og:image",
        image.startsWith("http") ? image : `https://cotzia.com${image}`
      );
    }
    if (url) {
      updateMetaProperty(
        "og:url",
        url.startsWith("http") ? url : `https://cotzia.com${url}`
      );
    }
