...
export const columns: ColumnDef<UsersData>[] = [
  ...
  createTranslatedColumn<UsersData, UserRole>("role", "Rol", translateUserRole, { alignment: "center" }),
  createTextColumn<UsersData>("workstation", "Puesto", { alignment: "center" }),
  createTranslatedColumn<UsersData, UserState>("state", "Estado", translateUserState, { alignment: "center" }),
