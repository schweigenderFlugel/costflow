...
const AddIndirectCost = dynamic(() => import("@/components/indirect-cost/crud/add-indirect-cost"))
const UpdateIndirectCost = dynamic(() => import("@/components/indirect-cost/crud/update-indirect-cost"))
const DeleteIndirectCost = dynamic(() => import("@/components/indirect-cost/crud/delete-indirect-cost"))
