...
const PageHeaderSection: FC<PageHeaderSectionProps> = ({ title, description, triggerInfo, children }) => {
  return <header className="flex align-middle flex-col justify-start gap-3 max-w-[calc(100svw-2rem)] w-6xl mx-auto px-1 sm:px-5 relative">
