          ...
          <SheetDescription asChild>
            <div>
              ...
              <p className="inline-block text-muted-foreground">
                Ejemplo: Alquiler, sueldos de empleados, consumo de luz, gas, fletes de la empresa.
              </p>
            </div>
          </SheetDescription>
        </SheetHeader>

        {
          !(alreadyCreated && indirectCostDetail)
            ...
            <IndirectCostForm
              ...
              errorMessage={createIndirectCost.error && (
            ...
            <div className="flex flex-col gap-6 my-auto px-0 sm:px-6">
              <div className="flex items-center flex-col gap-1">
                ...
                <p className="text-lg font-semibold text-center">Costo Indirecto creado</p>
              ...
              <Button type="button" disabled={createIndirectCost.isPending} variant={"outline"} onClick={() => setIsOpen(false)} className="rounded-xs cursor-pointer mx-auto w-3/4">
                Cerrar
              </Button>
            </div>
        }
