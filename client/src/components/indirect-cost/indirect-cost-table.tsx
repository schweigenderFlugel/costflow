...
const IndirectCost = ({
  ...
  className?: string;
  getData: Promise<IndirectCostObj[]>;
}) => {
  const data: IndirectCostObj[] | { error?: string; detail?: string } =
    use<IndirectCostObj[]>(getData);
  ...
  return (
    <section className={className}>
      ...
      <GenericDataTable<IndirectCostObj>
        ...
        initialData={
          !("error" in data || "detail" in data) ? data : indirectCostMock
        }
        columns={columns}
      />
    </section>
