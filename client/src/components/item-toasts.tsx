...
export const itemToasts = {
  ...
  deleteSuccess: ({ description, type = "insumo", duration = 5000 }: ItemToastData) => {
    toast.success(`¡${type.charAt(0).toUpperCase() + type.slice(1)} eliminado exitosamente!`, {
      description: (
  ...
  createSuccess: ({ description, type = "insumo", duration = 4000 }: ItemToastData) => {
    toast.success(`¡${type.charAt(0).toUpperCase() + type.slice(1)} creado exitosamente!`, {
      description: (
        <div className="flex items-center gap-2">
          <span className="font-normal text-muted-foreground">{description}</span>
        </div>
  ...
  updateSuccess: ({ description, type = "insumo", duration = 4000 }: ItemToastData) => {

    toast.success(`¡${type.charAt(0).toUpperCase() + type.slice(1)} actualizado exitosamente!`, {
      description: (
        <div className="flex items-center gap-2">
          <span className="font-normal text-muted-foreground">{description}</span>
        </div>
  ...
  // Toast para errores
  error: ({ description, type = "insumo", duration = 6000, message }: ItemToastData & { message?: string }) => {

    toast.error(`Error con el ${type}`, {
      description: (
  ...
  // Toast informativo
  info: ({ description, type = "insumo", duration = 4000, message }: ItemToastData & { message?: string }) => {
