...
import type { NavItem as NavItemProp } from "@/layouts/navigation";


const NavItem = ({ item, isActive }: { item: NavItemProp, isActive: boolean }) => {
  return (
    <Link
      ...
      className={
        cn("flex sm:flex-row flex-col items-center capitalize rounded-[6px]",
